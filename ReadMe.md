...
2. How would you explain form validation to someone who has never programmed before?
   "Form validation is like when you go to enter an email when you sign up for something and it tells you that it is not an email if you forget a must have."
   --Literally how i would explain it to my fiance.
